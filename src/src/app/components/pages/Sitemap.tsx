...
const ROUTE_SECTIONS: RouteSection[] = [
    ...
    },
    {
      ...
      routes: [
        ...
        { path: '/category/apparel', label: 'Category: Apparel', description: 'Retro-inspired streetwear and essentials', dynamic: true },
        { path: '/category/accessories', label: 'Category: Accessories', description: 'Bags, pins, patches, and gaming gear', dynamic: true },
        { path: '/category/games', label: 'Category: Games', description: 'Board games, card games, and retro gaming', dynamic: true },
        { path: '/category/posters', label: 'Category: Posters', description: 'Art prints, wall art, and illustrations', dynamic: true },
        { path: '/category/collectibles', label: 'Category: Collectibles', description: 'Figurines, vinyl, and limited-run items', dynamic: true },
        { path: '/tag/retro', label: 'Tag: Retro', description: 'Products tagged retro', dynamic: true },
        { path: '/product/pixel-power-tee', label: 'Single Product', description: 'Example product page (Pixel Power Tee)', dynamic: true },
        { path: '/product/pixel-power-tee/sticky', label: 'Product (Sticky)', description: 'Product with sticky buy panel', dynamic: true },
        { path: '/product/neon-arcade-hoodie', label: 'Variable Product', description: 'Product with variations (Neon Arcade Hoodie)', dynamic: true },
    ...
    },
    {
      ...
      routes: [
        ...
        { path: '/blog/category/design', label: 'Category: Design', description: 'UI/UX and visual design', dynamic: true },
        { path: '/blog/category/news', label: 'Category: News', description: 'Latest news and updates', dynamic: true },
        { path: '/blog/author/alex-morgan', label: 'Author: Alex Morgan', description: 'Posts by Alex Morgan', dynamic: true },
        { path: '/blog/tag/wordpress', label: 'Tag: WordPress', description: 'WordPress tagged posts', dynamic: true },
        { path: '/blog/open-channels-ash-shaw', label: 'Single Post (Audio)', description: 'Scaling WordPress with Ash Shaw', dynamic: true },
        { path: '/blog/open-channels-ash-shaw/sidebar', label: 'Single Post (Sidebar)', description: 'Post with sidebar layout', dynamic: true },
        { path: '/blog/open-channels-ash-shaw/fullwidth', label: 'Single Post (Full Width)', description: 'Full width post layout', dynamic: true },
        { path: '/blog/getting-started-headless/standard', label: 'Single Post (Standard Format)', description: 'Standard format view', dynamic: true },
        { path: '/blog/open-channels-ash-shaw/audio', label: 'Single Post (Audio Format)', description: 'Audio/podcast format', dynamic: true },
        { path: '/blog/lightspeed-dev-workflow/video', label: 'Single Post (Video Format)', description: 'Video format view', dynamic: true },
        { path: '/blog/office-vibes-gallery/gallery', label: 'Single Post (Gallery Format)', description: 'Gallery format view', dynamic: true },
        { path: '/blog/quick-update-november/aside', label: 'Single Post (Aside Format)', description: 'Aside/status format', dynamic: true },
      ],
    },
    {
    ...
    },
    {
      ...
      routes: [
        ...
        { path: '/membership/premium', label: 'Single Membership', description: 'Example membership page (Premium)', dynamic: true },
        { path: '/membership/3d/premium', label: '3D Membership View', description: '3D interactive membership card', dynamic: true },
      ],
    },
    {
    ...
    },
    {
      ...
      routes: [
        ...
        { path: '/policies', label: 'Policies (Redirect)', description: 'Redirects to /privacy-policy' },
        { path: '/terms', label: 'Terms (Redirect)', description: 'Redirects to /terms-and-conditions' },
        { path: '/legal/privacy', label: 'Legal Privacy (Redirect)', description: 'Redirects to /privacy-policy' },
        { path: '/legal/terms', label: 'Legal Terms (Redirect)', description: 'Redirects to /terms-and-conditions' },
        { path: '/legal/privacy-policy', label: 'Legal Privacy Policy (Redirect)', description: 'Redirects to /privacy-policy' },
        { path: '/legal/terms-conditions', label: 'Legal Terms Conditions (Redirect)', description: 'Redirects to /terms-and-conditions' },
      ],
    },
    {
      title: 'Error Pages',
