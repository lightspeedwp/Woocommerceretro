...
const ROUTE_SECTIONS: RouteSection[] = [
    ...
    },
    {
      ...
      routes: [
        ...
        { path: '/shop/category/apparel', label: 'Category: Apparel', description: 'Retro-inspired streetwear and essentials', dynamic: true },
        { path: '/shop/category/accessories', label: 'Category: Accessories', description: 'Bags, pins, patches, and gaming gear', dynamic: true },
        { path: '/shop/category/games', label: 'Category: Games', description: 'Board games, card games, and retro gaming', dynamic: true },
        { path: '/shop/category/posters', label: 'Category: Posters', description: 'Art prints, wall art, and illustrations', dynamic: true },
        { path: '/shop/category/collectibles', label: 'Category: Collectibles', description: 'Figurines, vinyl, and limited-run items', dynamic: true },
        { path: '/shop/tag/retro', label: 'Tag: Retro', description: 'Products tagged retro', dynamic: true },
        { path: '/product/prod-app-01', label: 'Single Product', description: 'Example product page (Pixel Power Tee)', dynamic: true },
        { path: '/product/prod-app-01/sticky', label: 'Product (Sticky)', description: 'Product with sticky buy panel', dynamic: true },
        { path: '/variable-product/prod-app-02', label: 'Variable Product', description: 'Product with variations (Neon Arcade Hoodie)', dynamic: true },
