...
export function Logo(props) {
  var className = props.className || 'wp-site-logo--default';
  var variant = props.variant || 'default';
  var useExternalSVG = props.useExternalSVG || false;

  var logoSrc = variant === 'white' 
    ? '/woocommerce-logo-white.svg' 
  ...
  var fillColor = variant === 'white' ? 'var(--wp--preset--color--white)' 
...
export var ShopLogo = Logo;
export var MainLogo = Logo;